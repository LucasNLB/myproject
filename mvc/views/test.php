    ...
    <H1>HOT</H1>
        ...
        if(pg_num_rows($data["img"]) > 0){
            ...
            <div class="col-xs-6 col-sm-4"> 
                <a href=""><div class="img-product"><img src="../../img/<?php echo $row['nameimg']; ?>" alt="" ></div></a>
                <a href=""><div class="name-product">Ốp mới</div></a>
                <a href=""> <div class="price-product">12.000</div></a>
            </div>
